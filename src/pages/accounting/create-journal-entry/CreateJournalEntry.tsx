...
const CreateJournalEntry = () => {
            ...
            try {
                const [officesRes, currenciesRes, paymentTypesRes, glAccountsRes] = await Promise.all([
                    ...
                    glApi.retrieveAllAccounts(
                        //we need all accounts who have manual entries enabled, usage=1, and should be enabled
                        undefined,    // type
    ...
    //Logic for submitting the Journal Entry
