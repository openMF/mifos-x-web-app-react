...
/**
 * Mustache placeholders Fineract substitutes when it merges a template.
 * Grouped the way the editor offers them: client parameters are available on
 * client templates, the loan and repayment groups on loan templates.
 */
